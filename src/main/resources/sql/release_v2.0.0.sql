CREATE DATABASE  IF NOT EXISTS `alarm_center` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `alarm_center`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
-- Host: 192.168.30.110    Database: alarm_center
-- ------------------------------------------------------
...
CREATE TABLE `alarm_code` (
  ...
  `exe_id` bigint(20) DEFAULT NULL COMMENT '第三方内告警码id',
  `system_id` bigint(20) NOT NULL COMMENT '系统id',
  `position_id` bigint(20) NOT NULL COMMENT '位置id',
  `code` int(10) unsigned NOT NULL COMMENT '告警码',
  `name` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '告警名称',
  `reason` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT '告警原因',
  `level_id` bigint(20) NOT NULL COMMENT '告警级别',
  `handling_opinions` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT '处理意见',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index` (`system_id`,`position_id`,`code`,`is_deleted`),
  KEY `index1` (`is_deleted`,`system_id`)
...
CREATE TABLE `alarm_error` (
  ...
  `system_code` bigint(20) unsigned DEFAULT NULL COMMENT '系统编号',
  `line_code` bigint(20) DEFAULT NULL COMMENT '线路编号',
  `position_code` bigint(20) DEFAULT NULL COMMENT '车站编号',
  `device_code` bigint(20) unsigned DEFAULT NULL COMMENT '设备编号',
  `slot_code` bigint(20) unsigned DEFAULT NULL COMMENT '槽位编号',
  `alarm_code` int(10) unsigned DEFAULT NULL COMMENT '告警码',
  ...
  `error_content` varchar(2000) COLLATE utf8_bin DEFAULT NULL COMMENT '出错原因',
...
CREATE TABLE `alarm_history` (
  ...
  `subsystem_code` bigint(20) DEFAULT NULL COMMENT '子系统id',
  `line_id` bigint(20) NOT NULL COMMENT '线路id',
  `line_code` bigint(20) DEFAULT NULL COMMENT '线路id',
  `site_id` bigint(20) NOT NULL COMMENT '站点',
  `site_code` bigint(20) DEFAULT NULL COMMENT '站点',
  `device_id` bigint(20) NOT NULL COMMENT '设备',
  `device_code` bigint(20) DEFAULT NULL COMMENT '设备',
  `slot_id` bigint(20) NOT NULL COMMENT '槽位',
  `slot_code` bigint(20) DEFAULT NULL COMMENT '槽位',
  `alarm_code` bigint(20) NOT NULL COMMENT '告警码',
  `alarm_code_id` bigint(20) DEFAULT NULL COMMENT '告警码',
  `alarm_level` tinyint(4) NOT NULL COMMENT '告警等级',
  `alarm_name` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '告警名称',
  `alarm_reason` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '告警原因',
  `first_time` timestamp NULL DEFAULT NULL COMMENT '第一次告警时间',
  `final_time` timestamp NULL DEFAULT NULL COMMENT '最后一次告警时间',
  `frequency` int(11) NOT NULL DEFAULT '0' COMMENT '告警次数',
  ...
  `is_recovery` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否为告警恢复标识（0：否；1：是）',
  `alarm_state` tinyint(4) NOT NULL DEFAULT '0' COMMENT '告警状态(0待处理;1延迟告警;2手动确认;3自动确认;4手动过滤;5自动过滤;6手动清除;7自动清除)',
  `recovery_time` timestamp NULL DEFAULT NULL COMMENT '告警恢复时间',
  `delay_time` timestamp NULL DEFAULT NULL COMMENT '告警延迟时间',
  `alarm_frequency` int(11) DEFAULT NULL COMMENT '告警升级频次',
  `frequency_time` bigint(20) DEFAULT NULL COMMENT '告警升级频次单位时间',
  `experience_time` bigint(20) DEFAULT NULL COMMENT '告警升级经历时间',
  `alarm_remark` varchar(300) COLLATE utf8_bin DEFAULT NULL COMMENT '告警备注',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index_1` (`subsystem_id`,`line_id`,`site_id`,`device_id`,`slot_id`,`alarm_code`,`alarm_state`,`is_deleted`),
  KEY `index_2` (`subsystem_id`,`line_id`,`site_id`,`device_id`,`slot_id`,`alarm_code`,`alarm_state`),
  KEY `index_3` (`subsystem_id`,`line_id`,`site_id`,`device_id`,`slot_id`,`alarm_code`,`alarm_level`,`alarm_state`,`first_time`,`is_deleted`),
  KEY `index_4` (`subsystem_id`,`line_id`,`site_id`,`device_id`,`slot_id`,`alarm_code`,`is_recovery`,`alarm_state`,`is_deleted`),
  KEY `index_5` (`subsystem_id`,`line_id`,`site_id`,`device_id`,`slot_id`,`alarm_code`,`alarm_level`,`alarm_state`,`first_time`,`is_recovery`,`is_deleted`)
...
CREATE TABLE `alarm_level` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `code` tinyint(4) NOT NULL COMMENT '1 紧急告警 2 重要告警 3 一般告警',
  `name` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '告警级别名称',
  `color` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '告警级别色号',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `alarm_message` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `alarm_id` bigint(20) NOT NULL COMMENT '告警记录id',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index2` (`alarm_id`,`title`,`content`,`is_deleted`),
  KEY `index1` (`alarm_id`,`is_deleted`)
...
CREATE TABLE `alarm_rule` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL COMMENT '告警类型（1-告警延迟规则;2-告警入库过滤规则;3-告警过滤规则;4-告警确认规则;5-告警清除规则;6-告警升级规则;7-告警前转规则）',
  `name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '告警规则名称',
  `is_filter_system` tinyint(3) unsigned DEFAULT NULL COMMENT '0 不过滤系统 1 过滤系统',
  `is_filter_position` tinyint(3) unsigned DEFAULT NULL COMMENT '0 不过滤位置 1 过滤位置',
  `is_filter_device` tinyint(3) unsigned DEFAULT NULL COMMENT '0 不过滤设备 1 过滤设备',
  `is_filter_alarm` tinyint(3) unsigned DEFAULT NULL COMMENT '0 不过滤告警码 1 过滤告警码',
  `delay_time` bigint(20) DEFAULT NULL COMMENT '告警延迟时间间隔',
  `frequency` int(11) DEFAULT NULL COMMENT '单位时间告警次数限制',
  `frequency_time` bigint(20) DEFAULT NULL COMMENT '告警次数限制单位时间',
  `experience_time` bigint(20) DEFAULT NULL COMMENT '历时时间',
  `msg_config_id` bigint(20) DEFAULT NULL COMMENT '前转规则消息推送配置id',
...
CREATE TABLE `alarm_sound` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `system_id` bigint(20) NOT NULL COMMENT '系统id',
  `level_id` bigint(20) NOT NULL COMMENT '告警级别id',
  `sound_file` varchar(100) COLLATE utf8_bin NOT NULL COMMENT '语音文件',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `change_shifts` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `by_user_name` varchar(45) COLLATE utf8_bin NOT NULL,
  `to_user_name` varchar(45) COLLATE utf8_bin NOT NULL,
  `remark` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '更新人',
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`)
...
CREATE TABLE `device` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '设备名称',
  `exe_id` bigint(20) DEFAULT NULL COMMENT '该设备信息在客户端数据库中的id',
  `system_id` bigint(20) NOT NULL COMMENT '所属系统id，subsystem表主键',
  `position_id` bigint(20) NOT NULL COMMENT '设备位置id，position表主键',
  `device_code` int(11) NOT NULL COMMENT '设备编号',
  `brand` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '品牌型号',
  `serial_num` varchar(125) COLLATE utf8_bin DEFAULT NULL COMMENT '设备串号',
  `description` varchar(125) COLLATE utf8_bin DEFAULT NULL COMMENT '设备描述',
  `manufacturer` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '设备厂商',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index` (`system_id`,`position_id`,`device_code`,`is_deleted`),
  KEY `index1` (`system_id`,`position_id`)
...
CREATE TABLE `device_slot` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `exe_id` bigint(20) DEFAULT NULL COMMENT '该设备槽位信息在客户端数据库中的id',
  `system_id` bigint(20) DEFAULT NULL COMMENT '所属系统id，subsystem表主键',
  `position_id` bigint(20) DEFAULT NULL COMMENT '设备位置id，position表主键',
  `device_id` bigint(20) NOT NULL COMMENT '设备id，device表主键',
  `slot_code` int(11) NOT NULL COMMENT '槽位编号',
  `name` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '槽位名称',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index` (`system_id`,`position_id`,`device_id`,`slot_code`,`is_deleted`)
...
CREATE TABLE `dic` (
  ...
  `is_enable` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态：0-停用，1-启用',
...
CREATE TABLE `dic_data` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `key` smallint(6) NOT NULL COMMENT '字典键值',
  `value` varchar(30) NOT NULL COMMENT '字典标签',
  `type` varchar(20) NOT NULL COMMENT '类型',
  `order` tinyint(4) DEFAULT NULL COMMENT '字典排序',
...
CREATE TABLE `filter_alarm` (
  ...
  `alarm_code_id` bigint(20) NOT NULL COMMENT '告警码id',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `menu` (
  ...
  `is_catalog` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否为目录',
  `catalog_id` bigint(20) DEFAULT NULL COMMENT '目录id',
  `is_menu` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否为菜单',
  `menu_id` bigint(20) DEFAULT NULL COMMENT '菜单id',
  `menu_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '名称',
  `menu_type` tinyint(4) DEFAULT NULL COMMENT '类型',
  `menu_sort` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '排序',
  `menu_value` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '路由地址',
  `role_identify` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '权限标识',
...
CREATE TABLE `msg_config` (
  ...
  `type` tinyint(4) DEFAULT NULL COMMENT '类型（1-短信，2-邮件，3-告警箱）',
  `phone` char(11) COLLATE utf8_bin DEFAULT NULL COMMENT '手机号',
  `email` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '邮箱',
  `box` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '告警箱',
...
CREATE TABLE `msg_push_history` (
  ...
  `email` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '邮箱',
  `box` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '告警箱',
  `content` varchar(4000) COLLATE utf8_bin DEFAULT NULL COMMENT '消息推送内容',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `operation_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_name` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '操作员名称',
  `operation_time` timestamp NULL DEFAULT NULL COMMENT '操作时间',
  `operation_type` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '操作类型',
  `use_time` int(11) DEFAULT NULL COMMENT '用时',
  `params` text COLLATE utf8_bin COMMENT '参数',
  `host_ip` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '主机IP',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`)
...
CREATE TABLE `position` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `p_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '父节点id',
  `position_code` int(11) DEFAULT NULL COMMENT '位置编码',
  `name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '节点名称',
  `icon` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '位置图标',
  `topographic` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '地形图',
  `type` tinyint(1) NOT NULL COMMENT '节点类型，1-地图，2-线路，3-车站',
  `coordinate` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '坐标',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`),
  KEY `index1` (`position_code`,`type`,`is_deleted`),
  KEY `index2` (`p_id`,`position_code`,`type`,`is_deleted`)
...
CREATE TABLE `role` (
  ...
  `role_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '角色名',
  `role_str` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '权限字符',
...
CREATE TABLE `snmp_alarm_code` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `system_id` bigint(20) NOT NULL COMMENT '子系统表id',
  `positionId` bigint(20) NOT NULL COMMENT '位置id',
  `element_type` varchar(35) COLLATE utf8_bin DEFAULT NULL COMMENT '网元类型',
  `snmp_code` varchar(125) COLLATE utf8_bin DEFAULT NULL COMMENT 'snmp码',
  `code` int(11) NOT NULL COMMENT '告警码',
  `reason` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '告警原因',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `snmp_slot` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `system_id` bigint(20) NOT NULL COMMENT '子系统id，subsystem表主键',
  `position_id` bigint(20) NOT NULL COMMENT '位置id，position表主键',
  `slot_id` bigint(20) DEFAULT NULL COMMENT '槽位id，slot表主键',
  `name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'snmp槽位名称',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `subsystem` (
  ...
  `name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '子系统名称',
  ...
  `icon` varchar(4000) COLLATE utf8_bin DEFAULT NULL COMMENT '子系统图标',
...
INSERT INTO `subsystem` VALUES (1,0,2,'告警',0,'127.0.0.1',56232,'group1/M00/00/00/wKgeZ2BIN7-Adp2KABwsPhhIAlg970.png',1,'2021-04-20 08:43:11',99,'2021-03-05 08:39:49','2021-04-20 08:43:24','1','1',0),(2,1,2,'传输',1,'127.0.0.1',8001,'group1/M00/00/00/wKgeZ2BIN9yAU0coABwsPhhIAlg379.png',1,'2021-06-16 03:03:42',1,'2021-03-05 08:39:55','2021-06-16 03:03:55','1','1',0),(3,1,2,'专用电话',2,'127.0.0.1',8002,'group1/M00/00/00/wKgeZ2Bj6KeAQAZBAADor8MMi2w825.png',1,'2021-05-20 03:06:05',2,'2021-03-31 03:12:41','2021-05-20 03:06:18','1','admin',0),(21,1,2,'无线',3,'127.0.0.1',8003,'group1/M00/00/00/wKgeZ2Bj6KeAQAZBAADor8MMi2w825.png',1,'2021-06-10 09:56:40',3,'2021-03-31 03:12:41','2021-06-10 09:56:53','1',NULL,0),(22,1,2,'CCTV',4,'127.0.0.1',8004,'group1/M00/00/00/wKgeZ2Bj6OSAe5MBAADor8MMi2w519.png',1,'2021-06-10 09:54:25',4,'2021-03-31 03:13:42','2021-06-10 09:54:38','1',NULL,0),(23,1,2,'广播',5,'127.0.0.1',8005,'group1/M00/00/00/wKgeZ2Bj6PeALDteAADor8MMi2w538.png',1,'2021-04-20 08:40:11',5,'2021-03-31 03:14:01','2021-04-20 08:40:24','1',NULL,0),(24,1,2,'时钟',6,'127.0.0.1',8006,'group1/M00/00/00/wKgeZ2Bj6QaAEHJVAADor8MMi2w858.png',1,'2021-04-20 08:40:11',6,'2021-03-31 03:14:16','2021-04-20 08:40:25','1',NULL,0),(25,1,2,'电源',7,'127.0.0.1',8007,'group1/M00/00/00/wKgeZ2Bj6RiAYoucAADor8MMi2w117.png',1,'2021-04-20 08:40:11',7,'2021-03-31 03:14:33','2021-04-20 08:40:29','1',NULL,0),(26,1,2,'乘客',8,'127.0.0.1',8008,'group1/M00/00/00/wKgeZ2B1LISAQE-2AABZBAQAzUY456.gif',1,'2021-04-20 08:41:11',8,'2021-03-31 03:14:51','2021-04-20 08:41:24','1','admin',0),(27,1,2,'公务电话',9,'127.0.0.1',8099,'group1/M00/00/00/wKgeZ2CZ8JOARi07ABxMDASR3ng752.png',1,'2021-04-20 08:41:11',9,'2021-03-31 03:15:14','2021-05-11 02:48:53','1','admin',0),(28,1,2,'OA',12,'127.0.0.1',8012,'group1/M00/00/00/wKgeZ2Bj6UGAW43yAADor8MMi2w609.png',1,'2021-04-20 08:43:11',12,'2021-03-31 03:15:14','2021-04-20 08:43:24','1',NULL,0);
...
CREATE TABLE `system_parameter` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `parameter` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '参数',
  `parameter_describe` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '参数描述',
  `parameter_value` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '参数值',
  `value_describe` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '参数值描述',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created_by` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '创建人',
  `updated_by` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '更新人',
...
CREATE TABLE `user` (
  ...
  `user_real_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT '用户真实姓名',
  `password` text COLLATE utf8_bin NOT NULL COMMENT '密码（加密）',
  `phone` char(11) COLLATE utf8_bin DEFAULT NULL COMMENT '手机号',
  `mail` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '邮箱',
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='管理平台用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_role` (
  ...
  `is_deleted` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '删除标志',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-17 14:43:17
